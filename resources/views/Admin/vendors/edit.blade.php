...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form action="{{route('admin.vendors.update',$vendors->id)}}" method="post" enctype="multipart/form-data" class="bg-white p-4">
                @csrf
                ...
                <div class="form-group">
                    <div class="text-center">
                        <img src="{{$vendors->logo}}" alt="Vendors" width="70px" height="70px">
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <input type="text" name="name" value="{{$vendors->name}}" class="form-control"  placeholder="">
                            @error("name")
                                <label class="text-danger">{{$message}}</label>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input type="text" name="email" value="{{$vendors->email}}" class="form-control"  placeholder="">
                            @error("email")
                                <label class="text-danger">{{$message}}</label>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input type="number" name="mobile" value="{{$vendors->mobile}}" class="form-control"  placeholder="">
                            @error("mobile")
                                <label class="text-danger">{{$message}}</label>
                            @enderror
                        </div>
                                ...
                                @if($Main_Categories && $Main_Categories -> count() > 0)
                                    @foreach ($Main_Categories as $category)
                                            <option value="{{$category->id}}" 
                                                @if ($category->id == $vendors->category_id) selected 
                                                    @endif                                            
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input type="checkbox" value="1" @if($vendors->active == 1) checked @endif name="active" />
                            @error("active")
                                <label class="text-danger">{{$message}}</label>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-lg-12">
                            <input type="text" value="{{$vendors->address}}" name="address" placeholder="Enter Address" class="form-control">
                            @error("address")   
                                <label class="text-danger">{{$message}}</label>
                            @enderror
                        </div>
