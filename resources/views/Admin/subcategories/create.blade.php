...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form action="{{Route('admin.subcategories.store')}}" method="post" enctype="multipart/form-data" class="bg-white p-4">
                @csrf
                <div class="row">
                    ...
                    @if(get_language() -> count() > 0)
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <input type="checkbox" value="1" checked="checked" name="category[{{$index}}][active]" />
