                        ...
                        @isset($SubCategories)                            
                            @foreach ($SubCategories as $item)
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary" href="{{Route('admin.subcategories.edit',$item->id)}}" >Update</a></td>
                                    <td><a class="btn btn-danger" href="{{Route('admin.subcategories.delete',$item->id)}}" >Delete</a></td>
                                    <td><a class="btn btn-dark" href="{{route('admin.subcategories.status',$item->id)}}" >
                                       @if($item->active == 1)  
                                            Activated
                                        @else 
                                            Deactive
