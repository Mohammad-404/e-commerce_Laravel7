    ...
    <!-- All script -->
    <script src="{{asset('Admin_Lib/js/vendor/jquery-1.10.2.min.js')}}"></script>
    <script src="{{asset('Admin_Lib/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('Admin_Lib/js/smoothscroll.js')}}"></script>
    <!-- Scroll up js
============================================ -->
    <script src="{{asset('Admin_Lib/js/jquery.scrollUp.js')}}"></script>
    <script src="{{asset('Admin_Lib/js/menu.js')}}"></script>
    <!-- new collection section script -->
    <script src="{{asset('Admin_Lib/js/swiper/idangerous.swiper.min.js')}}"></script>
    <script src="{{asset('Admin_Lib/js/swiper/swiper.custom.js')}}"></script>

    <!-- Magnific Popup -->
    <script src="{{asset('Admin_Lib/js/jquery.magnific-popup.min.js')}}"></script>

    <script src="{{asset('Admin_Lib/js/jquery.countdown.min.js')}}"></script>

    <!-- SLIDER REVOLUTION SCRIPTS  -->
    <script type="text/javascript" src="{{asset('Admin_Lib/rs-plugin/js/jquery.themepunch.plugins.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('Admin_Lib/rs-plugin/js/jquery.themepunch.revolution.min.js')}}"></script>
    <!-- Owl carousel -->
    <script src="{{asset('Admin_Lib/js/owl.carousel.min.js')}}"></script>
    <script src="{{asset('Admin_Lib/js/main.js')}}"></script>
...
<script>
    hideSliderAtLimit: 0, hideCaptionAtLimit: 500, hideAllCaptionAtLilmit: 500, videoJsPath: "rs-plugin/videojs/", fullScreenOffsetContainer: "" });
</script>
